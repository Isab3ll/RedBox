	...
	async function fetchCleanup() {
		...
		if (data.status === "success") {
			if (!data.output.trim()) {
				...
				cleanupStatus = "Containers still running, please perform cleanup again";
			}
		} else {
...
<div class="counter-container">
	<div class="counter-box">
		...
		<div class="counter">
			<button class="minus" on:click={() => (nginx_count = Math.max(0, nginx_count - 1))}>
				-
			</button>
	...
	<div class="counter-box">
		...
		<div class="counter">
			<button class="minus" on:click={() => (tomcat_count = Math.max(0, tomcat_count - 1))}>
				-
			</button>
	...
	<div class="counter-box">
		...
		<div class="counter">
			<button class="minus" on:click={() => (mysql_count = Math.max(0, mysql_count - 1))}>
				-
			</button>
	...
	<div class="counter-box">
		...
		<div class="counter">
			<button class="minus" on:click={() => (redis_count = Math.max(0, redis_count - 1))}>
				-
			</button>
	...
	<div class="counter-box">
		...
		<div class="counter">
			<button
				class="minus"
				on:click={() => (wordpress_count = Math.max(0, wordpress_count - 1))}
			>
				-
			</button>
	...
	<div class="counter-box">
		...
		<div class="counter">
			<button
				class="minus"
				on:click={() => (rabbitmq_count = Math.max(0, rabbitmq_count - 1))}
			>
				-
			</button>
	...
	<div class="counter-box">
		...
		<div class="counter">
			<button class="minus" on:click={() => (httpd_count = Math.max(0, httpd_count - 1))}>
				-
			</button>
...
<button class="action-button" on:click={destroyEnvironment} disabled={isCleaning}>
	Destroy Environment
</button>
<p>{cleanupStatus}</p>
<br />
